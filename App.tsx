...
import { View, Text, ScrollView, TouchableOpacity, Image, StyleSheet, StatusBar, TextInput } from 'react-native';
import { Ionicons } from '@expo/vector-icons';

const categories = [
  { id: '1', name: 'پلو و چلو', icon: 'restaurant-outline' },
  { id: '2', name: 'خورشت', icon: 'flame-outline' },
  { id: '3', name: 'کباب', icon: 'flame-outline' },
    ...
    <View style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 100 }}>
        <View style={styles.bannerContainer}>
          <Image source={{ uri: 'https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?q=80&w=1000&auto=format&fit=crop' }} style={styles.bannerImage} />
            ...
            {categories.map((cat) => (
              <TouchableOpacity key={cat.id} style={styles.catItem}>
                <View style={styles.catCircle}>
                  <Ionicons name={cat.icon} size={28} color="#E07A3F" />
                </View>
